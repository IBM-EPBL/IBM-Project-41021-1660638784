...
model = pickle.load(open('resale_value.sav', 'rb'))
...
def predict():
    ...
    if request.method == 'POST':
        ...
        if output<0:
            return render_template('resalepredict.html',prediction_text="❌ Sorry you cannot predict this car. 🙁")

        else:
            return render_template('resalepredict.html',prediction_text="✅ The resale value predicated is  {} lakhs".format(output))
